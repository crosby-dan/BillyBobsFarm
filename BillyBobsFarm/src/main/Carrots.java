...
public class Carrots extends Plant {
	final private int plantIndex=0;
	final private String plantName="Carrot";

	//constructor 
	Carrots(int quantity) {
	...
	public void checkPlantProgress()
	{
		...
		//A chance of a rabbits in any given round
		if ((Math.random()*100)>55) {
			...
			System.out.format("Your carrot patch has been invaded by Rabbits, and %d of %d plants were destroyed!", plantsDestroyed,super.plantQuantity);
